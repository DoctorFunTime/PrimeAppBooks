...
namespace PrimeAppBooks.Migrations
{
    ...
    [Migration("20260112003318_ImportStudents")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrimeAppBooks.Models.DeferralSchedule", b =>
                {
                    b.Property<int>("DeferralScheduleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("DeferralScheduleId"));
                    ...
                    b.HasKey("DeferralScheduleId");

                    b.HasIndex("CustomerId");

                    b.ToTable("DeferralSchedules");
                });
            ...
            modelBuilder.Entity("PrimeAppBooks.Models.Pages.TransactionsModels+JournalLine", b =>
                {
                    ...
                    b.Property<decimal>("ForeignCreditAmount")
                        ...
                        .HasColumnType("numeric(18,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("foreign_credit_amount");
                    ...
                    b.Property<decimal>("ForeignDebitAmount")
                        ...
                        .HasColumnType("numeric(18,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("foreign_debit_amount");
            ...
            modelBuilder.Entity("PrimeAppBooks.Models.PaymentPlan", b =>
                {
            ...
            modelBuilder.Entity("PrimeAppBooks.Models.PaymentTerm", b =>
                {
                    b.Property<int>("PaymentTermId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PaymentTermId"));
            ...
            modelBuilder.Entity("PrimeAppBooks.Models.PendingChange", b =>
                {
                    b.Property<int>("PendingChangeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PendingChangeId"));

                    b.Property<decimal>("AmountHeld")
                        .HasColumnType("numeric");

                    b.Property<decimal>("ChangeOwed")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("PrimeAppBooks.Models.Pages.TransactionsModels+JournalLine", b =>
                {
                    ...
                    b.HasOne("PrimeAppBooks.Models.Pages.TransactionsModels+BankReconciliation", "BankReconciliation")
